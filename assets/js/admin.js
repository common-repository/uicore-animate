...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__popup_base_vue__ = __webpack_require__(23);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_close_vue__ = __webpack_require__(26);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__uicore_mini_toggle_vue__ = __webpack_require__(28);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["a"] = ({
  name: "App",
  components: {
    uibase: __WEBPACK_IMPORTED_MODULE_0__popup_base_vue__["a" /* default */],
    toggle: __WEBPACK_IMPORTED_MODULE_2__uicore_mini_toggle_vue__["a" /* default */],
    close: __WEBPACK_IMPORTED_MODULE_1__components_close_vue__["a" /* default */]
  },
  data() {
    return {
      active: true,
      ...
      splitAnimations: window.uicore_split_animations_list,
      dragging: null,
      keys: []
    };
  },
  ...
  methods: {
    ...
    reset() {
      ...
      this.inputDelay = "200";
      this.inputStagger = "100";
      this.selectedSplit = false;
    ...
    setModel(model) {
      ...
      if (this.active) {
        ...
        if (!this.group) {
          ...
          this.widgetModels = {};
          this.keys = [];
          this.selectedAnimation = model.attributes.elType != 'widget' ? model.attributes.settings.attributes.animation + "" : model.attributes.settings.attributes._animation + "";
          this.selectedDuration = model.attributes.settings.attributes.animation_duration + "";
          this.inputDelay = model.attributes.elType != 'widget' ? model.attributes.settings.attributes.animation_delay + "" : model.attributes.settings.attributes._animation_delay + "";
        ...
        console.log(model.attributes.settings.attributes._animation);
        console.log(model.attributes.settings.attributes);
        this.widgetModels[widgetId] = {};
        this.widgetModels[widgetId]["uianim_id"] = model.id;
        this.widgetModels[widgetId]["uianim_name"] = model.attributes.settings.attributes._title || (model.attributes.elType == 'widget' ? model.attributes.widgetType : model.attributes.elType);
    ...
    update(cid, index) {
      ...
      const delay = isNaN(parseInt(this.inputDelay)) ? 0 : parseInt(this.inputDelay);
      const delayVaue = this.stagger ? delay + this.inputStagger * index : this.inputDelay + "";

      if (widget.type == 'widget') {
        settings._animation = this.selectedAnimation + "";
        settings._animation_delay = delayVaue;
      } else {

        //the container animation is stored in a different place
        settings.animation = this.selectedAnimation + "";
        settings.animation_delay = delayVaue;
      }
      ...
      if (this.split == 1 && this.selectedSplit) {
        settings.ui_animate_split = "ui-split-animate";
        ...
        //if split is off (force set it off)
      } else if (this.split == 1 && !this.selectedSplit) {
        settings.ui_animate_split = "";
      }
    ...
    validateControls(source, target) {
      ...
      if (null === source || null === target || undefined === source || undefined === target || "object" === typeof source ^ "object" === typeof target) {
        result = false;
      }
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_200a6b1e_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_App_vue__ = __webpack_require__(31);
var disposed = false
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_popup_base_vue__ = __webpack_require__(7);
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_e08ca8dc_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_popup_base_vue__ = __webpack_require__(25);
var disposed = false
function injectStyle (ssrContext) {
  if (disposed) return
...
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_popup_base_vue__["a" /* default */],
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_close_vue__ = __webpack_require__(8);
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_6749abf2_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_close_vue__ = __webpack_require__(27);
var disposed = false
var normalizeComponent = __webpack_require__(0)
/* script */
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_uicore_mini_toggle_vue__ = __webpack_require__(9);
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_0653b430_hasScoped_true_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_uicore_mini_toggle_vue__ = __webpack_require__(30);
var disposed = false
function injectStyle (ssrContext) {
  if (disposed) return
...
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_uicore_mini_toggle_vue__["a" /* default */],
                  ...
                  [
                    _c(
                      "label",
                      {
                        ...
                        attrs: {
                          title:
                            "Update the settings live while you change them"
                        }
                      },
                      [_vm._v(" Auto Apply ")]
                    ),
                  ...
                  [
                    _c(
                      "label",
                      {
                        staticClass: "uicore_h2",
                        attrs: {
                          title: "Select and animate multiple widget at once"
                        }
                      },
                      ...
                      [
                        _c(
                          "label",
                          {
                            staticClass: "uicore_h2",
                            attrs: {
                              title: "Enable delay between widgets animation"
                            }
                          },
                  ...
                  ? _c("div", { staticClass: "uicore-core-setting" }, [
                      _c(
                        "label",
                        {
                          staticClass: "uicore_h2",
                          attrs: {
                            title: "Set the desired delay between items"
                          }
                        },
                        [_vm._v("Items Delay")]
                      ),
                ...
                _c("div", { staticClass: "uicore-core-setting" }, [
                  _c(
                    "label",
                    {
                      staticClass: "uicore_h2",
                      attrs: {
                        for: "uianim_animation",
                        title: "Widget aniamtion"
                      }
                    },
                    [_vm._v("Animation")]
                  ),
                          ...
                          _c(
                            "label",
                            {
                              ...
                              attrs: {
                                for: "uianim_duration",
                                title:
                                  "Set the animation duration(for each item)"
                              }
                            },
                            [_vm._v("Duration")]
                          ),
                        ...
                        [
                          _c(
                            "label",
                            {
                              ...
                              attrs: {
                                for: "uianim_delay",
                                title: "Initial animation delay time"
                              }
                            },
                            [_vm._v("Delay")]
                          ),
                          ...
                          _c("input", {
                            ...
                            attrs: { id: "uianim_delay", type: "number" },
                      ...
                      [
                        _c(
                          "label",
                          {
                            ...
                            attrs: {
                              title:
                                "Enable Split Text animation (split by characters, words or lines)"
                            }
                          },
                          ...
                          _c(
                            "label",
                            {
                              ...
                              attrs: {
                                ...
                                title: "Chose how to split your text"
                              }
                            },
                            [_vm._v("Split By")]
                          ),
                        ...
                        [
                          _c(
                            "label",
                            {
                              staticClass: "uicore_h2",
                              attrs: {
                                for: "uianim_split_animation",
                                title: "Chose splited items animation"
                              }
                            },
                            [_vm._v("Animation")]
                          ),
                          ...
                          _c(
                            ...
                            _vm._l(_vm.splitAnimations, function(
                              animation,
                              animationName
                            ) {
                              return _c(
                        ...
                        [
                          _c(
                            "label",
                            {
                              staticClass: "uicore_h2",
                              attrs: {
                                for: "uianim_split_duration",
                                title: "Set Splited items animation duration"
                              }
                            },
                            [_vm._v("Duration")]
                          ),
                        ...
                        [
                          _c(
                            "label",
                            {
                              staticClass: "uicore_h2",
                              attrs: {
                                for: "uianim_split_delay",
                                title: "Initial split animation delay"
                              }
                            },
                            [_vm._v("Delay")]
                          ),
                          ...
                          _c("input", {
                            ...
                            attrs: { id: "uianim_split_delay", type: "number" },
                        ...
                        [
                          _c(
                            "label",
                            {
                              staticClass: "uicore_h2",
                              attrs: {
                                for: "uianim_split_stagger",
                                title:
                                  "Set the delay between splited items (in your case:" +
                                  _vm.selectedSplitBy +
                                  ")"
                              }
                            },
                            [
                              _vm._v(
                                _vm._s(
                                  _vm.selectedSplitBy.charAt(0).toUpperCase() +
                                    _vm.selectedSplitBy.slice(1)
                                ) + " delay"
                              )
                            ]
                          ),
                ...
                _c("div", { staticClass: "uianim-actions" }, [
                  _c(
                    "div",
                    {
                      ...
                      attrs: {
                        title: !_vm.apply
                          ? "Apply the settings to the widget"
                  ...
                  _c(
                    "div",
                    {
                      staticClass: "uianim-btn uianim-text",
                      attrs: { title: "Clear all widget from list" },
